...
Projeyi tek adımda kurmak ve başlatmak için terminale şu komutu yapıştırın:
```bash
git clone https://github.com/bfurkanyildiz/NetVanguard.git && cd NetVanguard && chmod +x setup.sh run.sh && ./setup.sh && ./run.sh
```
