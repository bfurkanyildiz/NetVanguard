...
<table border="1" width="100%">
  <tr>
    <td align="center" width="50%">
      <img src="https://upload.wikimedia.org/wikipedia/tr/6/69/%C4%B0stinye_%C3%9Cniversitesi_logo.png" width="250" alt="ISU Logo">
    </td>
    <td align="center" width="50%">
      <h2>Sızma Testi Proje Ödevi</h2>
    </td>
  </tr>
  <tr>
    <td><b>Öğrenci Adı</b></td>
    <td>Baha Furkan Yıldız</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><b>Öğretim Gör. (Danışman)</b></td>
    <td>Keyvan Arasteh</td>
  </tr>
  <tr>
    <td><b>Ders Kodu & Adı</b></td>
    <td>BGT006 Sızma Testi</td>
  </tr>
</table>
...
|---|---|
| *Öğrenci Adı* | BAHA FURKAN YILDIZ |
| *Öğrenci No.* | 2520191009 |
...
## Table of Contents
- [🛡️ NetVanguard v1.0.1](#️-netvanguard-v101)
- [🇹🇷 Türkçe Versiyon](#-türkçe-versiyon)
  - [🚀 Ana Modüller](#-ana-modüller-ve-kabiliyetler)
  - [⚡ Akıllı Kurulum](#-akıllı-kurulum-smart-setup)
- [🇺🇸 English Version](#-english-version)
- [⚖️ Legal Disclaimer](#-legal-disclaimer)
> [!TIP]
> For more detailed technical documentation, architecture diagrams, and research notes, please visit the [**Project Documentation Folder**](./docs).
...
NetVanguard'ın kararlı çalışması için aşağıdaki bileşenler gereklidir:
- **Sistem:** [Rust (2021 Edition)](https://www.rust-lang.org/), [Nmap Engine](https://nmap.org/) (v7.90+), `libpcap-dev` (Linux paket yakalama).
- **Backend (Rust):** `axum` (Web & API), `tokio` (Async runtime), `pcap` (Sniffer logic), `reqwest` & `trust-dns-resolver` (Intelligence).
- **Frontend:** `Cytoscape.js` (Ağ Topolojisi), `Gauge.js` (Risk Göstergesi), `FontAwesome`.
...
Projenin derlenme, çalışma ve test süreçlerini gösteren demo videosu:
("Bu projede gerçekleştirilen BSSID tespiti ve Metasploitable zafiyet taramaları, tamamen eğitim amaçlı olup, yalnızca sahibi olduğum test laboratuvarı ortamında ve yasal izinler çerçevesinde güvenlik farkındalığı oluşturmak amacıyla icra edilmiştir.")

https://github.com/user-attachments/assets/8cc89b28-4b3a-4d99-8d4e-0604e9b125ea
...
### 📦 Dependencies
The following components are required for a stable NetVanguard installation:
- **System:** [Rust (2021 Edition)](https://www.rust-lang.org/), [Nmap Engine](https://nmap.org/) (v7.90+), `libpcap-dev` (Linux packet capture).
- **Backend (Rust):** `axum` (Web & API), `tokio` (Async runtime), `pcap` (Sniffer logic), `reqwest` & `trust-dns-resolver` (Intelligence).
- **Frontend:** `Cytoscape.js` (Network Topology), `Gauge.js` (Risk Metrics), `FontAwesome`.
