...
<div align="center">
  <img src="https://img.shields.io/badge/Total_Score-68%2F100-yellow?style=for-the-badge&logo=codecov" alt="Total Score"/>
  <img src="https://img.shields.io/badge/Status-NEEDS_WORK-black?style=for-the-badge" alt="Status"/>
  <img src="https://img.shields.io/badge/Technical_Depth-37-purple?style=for-the-badge" alt="Tech Depth"/>
</div>

| Attribute           | Value                                 |
| :------------------ | :------------------------------------ |
| **Student**         | `Baha Furkan Yıldız` (`2520191009`) |
...
| :--------------------- | :----------------: | :--------: | :---------------------------------------------------------------------- |
| **Technical Depth**    | `37`  |     25     | _(Röntgen Analizi)_ Deep structural / architectural execution.          |
| **Functional Tests**   |  `Pending/TBD`  |     30     | _(Ameliyat)_ Instructor's live dynamic execution & exploit payload.     |
| **Code Quality**       |  `65`  |     10     | Spaghetti functions, modularity, comment ratios, TODO fatigue.          |
| **Commit Consistency** | `100` |     10     | Avoid single-commit dumps. Surgery shouldn't be a single cut.           |
| **Documentation**      |  `75`  |     10     | Readme, architecture diagrams, installation instructions.               |
| **Repo Discipline**    |  `100`  |     10     | Proper directory structure, `.gitignore`, CI/CD, dependency management. |
| **Time Investment**    |  `80`  |     5      | Dedicated, spaced-out working sessions (concrete needs time to dry).    |
